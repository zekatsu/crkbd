...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  LGUI_T(KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L, KC_MINS, KC_BSPC,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      JP_TILD,  JP_EQL, JP_PLUS, JP_ASTR,   JP_AT, JP_CIRC,                      JP_LCBR, JP_LBRC, JP_LPRN, JP_QUOT, JP_SCLN, KC_INT1,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT,   KC_LT,   KC_GT, JP_COMM,  JP_DOT, JP_PIPE,                      JP_RCBR, JP_RBRC, JP_RPRN,  JP_DQT, KC_INT3, KC_RSFT,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          XXXXXXX,  KC_SPC,   LOWER,      RAISE,  KC_ENT, XXXXXXX \
                                      //`--------------------------'  `--------------------------'
  ),
